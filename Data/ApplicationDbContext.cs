...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser>(options)
{
    ...
    {  
        ...
        modelBuilder.Entity<Produit>().HasData(
            ...
            new Produit { Id = 6, Nom = "Smartphone 1", CategorieId = 3, Prix = 980, PrixAncien = 1000, BadgeNew = true, TopVente =true, Autre1 = true, Autre2 = true, Photo1 = "seed/smartphone1-1.png", Photo2 = "seed/smartphone1-2.png", Photo3 = "seed/smartphone1-3.png", Photo4 = "seed/smartphone1-4.png", Description = d, MarqueId = 3 },
